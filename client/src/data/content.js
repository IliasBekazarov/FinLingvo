...
export const LEAGUES = [
  { id: "bronze",   name: "ЖЕЗ",     emoji: "🥉", color: "#CD7F32", bg: "#2a1a08", glowColor: "rgba(205,127,50,0.45)",  minXP: 0    },
  { id: "silver",   name: "КҮМҮШ",   emoji: "🥈", color: "#B8BCC8", bg: "#1a1c2a", glowColor: "rgba(184,188,200,0.45)", minXP: 200  },
  { id: "gold",     name: "АЛТЫН",   emoji: "🥇", color: "#FFD700", bg: "#2a2200", glowColor: "rgba(255,215,0,0.45)",   minXP: 500  },
  { id: "ruby",     name: "РУБИН",   emoji: "♦️", color: "#FF4655", bg: "#2d0810", glowColor: "rgba(255,70,85,0.45)",   minXP: 1000 },
  { id: "emerald",  name: "ИЗИМРУД", emoji: "💚", color: "#00C896", bg: "#00241a", glowColor: "rgba(0,200,150,0.45)",   minXP: 2000 },
  { id: "amethyst", name: "АМЕТИСТ", emoji: "💜", color: "#A855F7", bg: "#1a0830", glowColor: "rgba(168,85,247,0.45)",  minXP: 4000 },
  { id: "pearl",    name: "БЕРМЕТ",  emoji: "🤍", color: "#22D3EE", bg: "#00182a", glowColor: "rgba(34,211,238,0.45)",  minXP: 7000 },
];
